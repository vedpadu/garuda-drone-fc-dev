...
#define PID_KP  0.028 // maybe raise this?
#define PID_KI  0.00
#define PID_KD  0.02
...
#define PID_RATE_LIM_MIN -2.0
#define PID_RATE_LIM_MAX  2.0
...
#define SAMPLE_TIME_S 0.004 // TODO: make this sample rate work pwease, im assuming a phase issue
